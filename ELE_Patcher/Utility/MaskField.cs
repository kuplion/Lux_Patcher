	...
	public static class EqualityMasks
	{
			...
			out Light.Mask<bool> moddedEquals, out HashSet<Light.Mask<bool>> vanillasEqual, out Light.TranslationMask doCopy)
		{
			...
			void AddMoreMasks(Light.Mask<bool> mask, ILightGetter first, ILightGetter second)
			{
				...
				mask.NearClip = Util.NearlyEquals(first.NearClip, second.NearClip);
				mask.FadeValue = Util.NearlyEquals(first.FadeValue, second.FadeValue);
			...
			out Cell.Mask<bool> moddedEquals, out HashSet<Cell.Mask<bool>> vanillasEqual, out Cell.TranslationMask doCopy)
		{
			...
			void AddMoreMasks(Cell.Mask<bool> mask, ICellGetter first, ICellGetter second)
			{
				...
				else
				{
					...
					mask.Lighting.Specific!.DirectionalFade = Util.NearlyEquals(firstL.DirectionalFade, secondL.DirectionalFade);
					mask.Lighting.Specific!.FogClipDistance = Util.NearlyEquals(firstL.FogClipDistance, secondL.FogClipDistance);
					mask.Lighting.Specific!.FogPower = Util.NearlyEquals(firstL.FogPower, secondL.FogPower);
					mask.Lighting.Specific!.FogMax = Util.NearlyEquals(firstL.FogMax, secondL.FogMax);
					mask.Lighting.Specific!.LightFadeBegin = Util.NearlyEquals(firstL.LightFadeBegin, secondL.LightFadeBegin);
					mask.Lighting.Specific!.LightFadeEnd = Util.NearlyEquals(firstL.LightFadeEnd, secondL.LightFadeEnd);
					mask.Lighting.Specific!.FogNear = Util.NearlyEquals(firstL.FogNear, secondL.FogNear);
			...
			out PlacedObject.Mask<bool> moddedEquals, out HashSet<PlacedObject.Mask<bool>> vanillasEqual, out PlacedObject.TranslationMask doCopy)
		{
			...
			void AddMoreMasks(PlacedObject.Mask<bool> mask, IPlacedObjectGetter first, IPlacedObjectGetter second)
			{
				...
				mask.BoundHalfExtents = Util.NearlyEquals(first.BoundHalfExtents, second.BoundHalfExtents);
